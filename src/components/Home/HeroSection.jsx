            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-center">
              <h1>
                <span className="mt-12 block text-4xl font-extrabold sm:text-5xl xl:text-6xl">
                  <span className="block text-black dark:text-white mb-1">
                    Discover Genuine
                  </span>
              ...
              <div class="p-4 w-full text-center rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-900">
                <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">
                  Discover video reviews on iOS & Android.
                  <br />
                  Download Tribeto now on and get started.
                </p>
                <div class="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                  <a
                    href="#"
                    class="w-full sm:w-auto bg-gray-900 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
                  >
                    <svg
                      class="mr-3 w-7 h-7"
                      aria-hidden="true"
